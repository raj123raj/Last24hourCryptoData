...
import com.lasttwentyfour.cryptodata.controller.CryptocurrencyLastTwentyFourHourController;
...
public class CryptocurrencyComparatorControllerTest {
    ...
    @Before
    public void setup() {
        this.mockMvc = MockMvcBuilders.standaloneSetup(new CryptocurrencyLastTwentyFourHourController()).build();
    }
